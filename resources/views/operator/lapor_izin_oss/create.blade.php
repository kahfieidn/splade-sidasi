        ...
        <div class="bg-white p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            ...
            <x-splade-form enctype="multipart/form-data" action="{{route('lapor-izin-oss.store')}}" method="post">
                ...
                <div class="grid md:grid-cols-3 md:gap-6">
                    ...
                    <div class="relative z-999 w-full mb-6 group">
                    <x-splade-file required name="berkas" filepond preview label="Lampiran (.xlsx)" accept="application/vnd.ms-excel, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, .xlsx" />
                    </div>
                </div>
