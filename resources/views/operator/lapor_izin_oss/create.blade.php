        ...
        <div class="bg-white p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            ...
            <x-splade-form enctype="multipart/form-data" action="{{route('lapor-izin-oss.store')}}" method="post">
                <div class="relative z-999 w-full mb-6 group">
                    <x-splade-select name="jenis_oss" label="Jenis Data OSS" choices :options="$jenis_oss" />
                </div>
                <div class="relative z-0 w-full mb-6 group">
                    <x-splade-file name="berkas" filepond preview label="Berkas (.xlsx)" accept="application/vnd.ms-excel, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, .xlsx" />
                </div>
                <div class="grid md:grid-cols-3 md:gap-6">
                    <div class="relative z-999 w-full mb-6 group">
                        <x-splade-select name="bulan" label="Periode Bulan" choices :options="$bulan" />
                    </div>
                    <div class="relative z-999 w-full mb-6 group">
                        <x-splade-select name="tahun" label="Periode Tahun" choices :options="$tahun" />
                    </div>
                    <div class="relative z-999 w-full mb-6 group">
                        <x-splade-input type="number" name="jumlah_data" label="Jumlah Keseluruhan Data" />
                    </div>
                </div>
