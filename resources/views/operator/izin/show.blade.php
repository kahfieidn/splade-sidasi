<x-app-layout>
    ...
    <x-splade-form :default="$izin" confirm="Konfirmasi" confirm-text="Apakah anda yakin sudah memastikan data sudah sesuai?" confirm-button="Ya, Saya Yakin!" cancel-button="Tidak, Masih ada yang salah!" action="{{ route('izin.update', $izin->id) }}" method="PATCH">
        <x-splade-input readonly class="hidden" name="id" />
        <div class="p-4 sm:ml-64">
            <div class="bg-white p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
                <h1 class="mb-8 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-3xl lg:text-4xl dark:text-white">Formulir <span class="underline underline-offset-3 decoration-8 decoration-blue-400 dark:decoration-blue-600">Edit Izin</span></h1>
                ...
                <x-splade-group>
                    <x-splade-submit class="mt-3 py-2" label="Update Data" />
                </x-splade-group>
            </div>
        </div>
    </x-splade-form>
